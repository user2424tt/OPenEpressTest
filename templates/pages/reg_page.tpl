...
<head>
    ...
    <title>ЭКСПРЕСС ТЕСТ - Регистрация</title>
</head>

<body>
    <div id="card">
    <form action="/register" method="post" class="card_form_1">
        <div>
            <p>Пользователь : </p><input name='name' class="input_login_password">
        </div>
        <div>
        ...
        <button class="button_login_registration">Регистрация</button>
        </form>
